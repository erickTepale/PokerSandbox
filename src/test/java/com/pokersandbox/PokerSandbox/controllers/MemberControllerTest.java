...
public class MemberControllerTest {
    ...
    public void register_newMember_Test() throws Exception {
        MemberRegister newMember = new MemberRegister(
                "arguello.chung@gmail.com",
                "chungarguello",
                "Chung11161989.",
                "Chung11161989."
        );
        Mockito.when(memberService.registerMember(newMember)).thenReturn("Account created");

        mockMvc.perform(
                MockMvcRequestBuilders.post("/member/register")
                        .content(asJsonString(newMember))
